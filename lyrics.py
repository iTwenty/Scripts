...
# march 2011
#
# script copy and pasted from different cover & lyrics scripts
# lots of stuff is copied from the Lyricsdownloader for Conky by eightmillion@gmail.com
# which can be downloaded from https://code.google.com/p/lyricsdownloader/
#
# dependencies (among others): mpc, python-beautifulsoup
#
# available options:
# -v for verbose output
# -a '${alignment}'   replace alignment by alignr, alignc or goto <number>
...
def lyricsmania(artist,title):
    ...
    f = file ('/home/itwenty/bin/htmllyrics.txt','w')
    f.write (text)
